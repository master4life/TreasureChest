    ...
    */
    ...
    public Menu setupNewMenu(Player player, String message) {
        ...
        mItem = new MenuItem("§bSelect a ZONE", new ItemStack(Material.WOODEN_AXE)) {
            ...
            public void onClick(Player player, InventoryClickType clickType) {
                if (clickType.isLeftClick()) {
                    if (ChestSelection.FIRST_SELECTION.get(player) != null || ChestSelection.SECOND_SELECTION.get(player) != null) {
                ...
                if (clickType.isRightClick()) {
                    ...
                    ChestSelection.FIRST_SELECTION.remove(player);
                    ChestSelection.SECOND_SELECTION.remove(player);
